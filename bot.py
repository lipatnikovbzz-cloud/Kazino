...
LOGS_ID = -1002658290230
BETS_ID = -1002512711500
BETS_LINK = os.getenv('BETS_CHANNEL_LINK', "https://t.me/+UOPg2ldiLoMyNzJi")
...
GIDE_LINK = os.getenv('GIDE_LINK', "https://t.me/BunnyCasinoGide")
                ...
                if not await db.has_seen_instruction(user_id):
                    ...
                    await bot.send_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                            ...
                            [InlineKeyboardButton(text='🤖 Cделать ставку', url="https://t.me/CasinoBunnyBot?start=games")]
